<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="FormularioCategoria.aspx.cs" Inherits="tp_comercio_Vargas_Delgado.FormularioCategoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mx-auto p-5" style="width: 400px;">
        <h2 class="text-center">Formulario Categoria</h2>
    </div>
    ...
    <div class="container justify-content-sm-center">
        ...
        <%
            ...
            {
        %>
        <asp:Button ID="btnEliminarCategoria" runat="server" Text="Eliminar" CssClass="btn btn-warning" BackColor="Red" OnClick="btnEliminar_Click" />
        <%
            }
        %>
