...
namespace tp_comercio_Vargas_Delgado
{
    public partial class FormularioRegistro : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                if (Session["RegistroSeleccionado"] != null && !IsPostBack)
                {
                    ...
                    if ((Session["usuariologueado"] != null && ((Dominio.RolUsuario)Session["rolusuario"]) == Dominio.RolUsuario.Administrador))
                    {
                        ...
                        txtDestinatario.Text = registro.Destinatario.ToString();
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            registro.Tipo = int.Parse(txtTipo.Text);
            registro.Destinatario = int.Parse(txtDestinatario.Text);
            ...
            Response.Redirect("WebVerRegistro.aspx", false);
        }
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            if (Session["RegistroSeleccionado"] != null)
            {
                ...
                Session.Remove("RegistroSeleccionado");
                Response.Redirect("WebVerRegistro.aspx");
            }
            else
            {
